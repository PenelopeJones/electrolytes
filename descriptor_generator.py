...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='1080',
                        help='First two digits correspond to the concentration (M), '
                             'e.g. 10 = 1.0M. Second two digits correspond to the '
    ...
    main(args.directory, args.dataset, args.num_files, args.box_length, args.bin_size,
         args.ion_size, args.min_r_value, args.max_r_value, args.smoothed)
